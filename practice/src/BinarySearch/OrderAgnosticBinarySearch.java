...
//if we dont know whether array is in ascending or descending order
//write a condtion for it that is order agnostic binary search
public class OrderAgnosticBinarySearch {
    public static void main(String[] args) {
        //Ascending
       // int[] arr = { -5,4,5,11,12,22,25,36,46,78,89};//creating an array and setting the values in it
        int[] arr = { 78,89,46,35,23,11,5,-3};
